...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NocNoc Core NocNoc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  NocNoc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NocNoc transaction") + "\n" +
                               "  NocNoc-tx [options] -create [commands]   " + _("Create hex-encoded NocNoc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NocNoc transaction
