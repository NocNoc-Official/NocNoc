...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NocNoc features */
        {"NocNoc", "masternode", &masternode, true, true, false},
        {"NocNoc", "listmasternodes", &listmasternodes, true, true, false},
        {"NocNoc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NocNoc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NocNoc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NocNoc", "masternodedebug", &masternodedebug, true, true, false},
        {"NocNoc", "startmasternode", &startmasternode, true, true, false},
        {"NocNoc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NocNoc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NocNoc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NocNoc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NocNoc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NocNoc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NocNoc", "mnbudget", &mnbudget, true, true, false},
        {"NocNoc", "preparebudget", &preparebudget, true, true, false},
        {"NocNoc", "submitbudget", &submitbudget, true, true, false},
        {"NocNoc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NocNoc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NocNoc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NocNoc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NocNoc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NocNoc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NocNoc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NocNoc", "checkbudgets", &checkbudgets, true, true, false},
        {"NocNoc", "mnsync", &mnsync, true, true, false},
        {"NocNoc", "spork", &spork, true, true, false},
        {"NocNoc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"NocNoc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> NocNoc-cli " + methodname + " " + args + "\n";
}
