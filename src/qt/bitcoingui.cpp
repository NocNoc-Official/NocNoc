                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NocNoc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NocNoc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NocNoc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NocNoc Core"), this);
    aboutAction->setStatusTip(tr("Show information about NocNoc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NocNoc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NocNoc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NocNoc addresses"));
    ...
    openAction->setStatusTip(tr("Open a NocNoc: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NocNoc Core help message to get a list with possible NocNoc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NocNoc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NocNoc network", "", count));
}
...
{
    QString strTitle = tr("NocNoc Core"); // default title
