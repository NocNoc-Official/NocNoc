...
/** Utility functions used by the NocNoc Qt UI.
 */
namespace GUIUtil
{
...
// Render NocNoc addresses in monospace font
...
// Parse "NocNoc:" URI into recipient object, return true on successful parsing
