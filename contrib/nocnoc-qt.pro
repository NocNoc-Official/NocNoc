...
RESOURCES += src/qt/nocnoc.qrc src/qt/nocnoc_locale.qrc

TRANSLATIONS += src/qt/locale/nocnoc_bg.ts \
                src/qt/locale/nocnoc_de.ts \
                src/qt/locale/nocnoc_en.ts \
                src/qt/locale/nocnoc_es.ts \
                src/qt/locale/nocnoc_fi.ts \
                src/qt/locale/nocnoc_fr.ts \
                src/qt/locale/nocnoc_it.ts \
                src/qt/locale/nocnoc_ja.ts \
                src/qt/locale/nocnoc_pl.ts \
                src/qt/locale/nocnoc_pt.ts \
                src/qt/locale/nocnoc_ru.ts \
                src/qt/locale/nocnoc_sk.ts \
                src/qt/locale/nocnoc_sv.ts \
                src/qt/locale/nocnoc_vi.ts \
                src/qt/locale/nocnoc_zh_CN.ts \
                src/qt/locale/nocnoc_zh_TW.ts
