...
# Copyright (c) 2019 The NocNoc Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

# Configuration settings
projectName="nocnoc"				# The name of the wallet or project
...
walletOutputDirectory="NOC-binaries"		# The directory where finished wallets will be stored
...
githubRepo="NOC"				# The name of the repo for the wallet project. Ie: repo name = gitian-builder from https://github.com/devrandom/gitian-builder
githubDetachedSigsRepo="nocnoc-detached-sigs"	# The name of the repo for the detached signatures.
