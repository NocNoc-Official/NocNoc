...
This means one can have an always-on nocnocd instance running, and another local nocnocd/nocnoc-qt instance which connects to this node and receives blocks from it.
