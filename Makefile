...
# Copyright (c) 2019 The nocnocHash developers
...
pkgdatadir = $(datadir)/nocnochash
pkgincludedir = $(includedir)/nocnochash
pkglibdir = $(libdir)/nocnochash
pkglibexecdir = $(libexecdir)/nocnochash
...
CONFIG_HEADER = $(top_builddir)/src/config/nocnochash-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/nocnochash-config.h.in \
...
ACLOCAL = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = nocnochash-cli
BITCOIN_DAEMON_NAME = nocnochashd
BITCOIN_GUI_NAME = nocnochash-qt
BITCOIN_TX_NAME = nocnochash-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = nocnochash
PACKAGE_BUGREPORT = www.nocnochash.io
PACKAGE_NAME = nocnocHash Core
PACKAGE_STRING = nocnocHash Core 2.0.0
PACKAGE_TARNAME = nocnochash
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/oem/Desktop/nocnochash
abs_srcdir = /home/oem/Desktop/nocnochash
abs_top_builddir = /home/oem/Desktop/nocnochash
abs_top_srcdir = /home/oem/Desktop/nocnochash
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/oem/Desktop/nocnochash/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/nocnoc.icns
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_nocnoc_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_nocnoc_coverage.info test_nocnoc.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/nocnoc.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/nocnocHash-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/nocnochash-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/nocnochash-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/nocnochash-config.h
$(top_srcdir)/src/config/nocnochash-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/nocnochash-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/nocnoc.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/nocnocHash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/nocnocHash-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/nocnocHash-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_nocnoc.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_nocnoc -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_nocnoc_filtered.info: test_nocnoc.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_nocnoc_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_nocnoc_coverage.info: baseline_filtered_combined.info test_nocnoc_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nocnoc_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_nocnoc_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nocnoc_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nocnoc.coverage/.dirstamp:  test_nocnoc_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_nocnoc.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_nocnoc.coverage/ total.coverage/ $(OSX_APP)
